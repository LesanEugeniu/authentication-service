...
import static auth.core.authenticationservice.exception.ErrorType.EMAIL_ALREADY_VERIFIED;
import static auth.core.authenticationservice.exception.ErrorType.EMAIL_VERIFICATION_FAILED;
...
public class EmailVerificationService {
    ...
    public User verifyEmailOtp(final String email, final String otp) {
        final var user = userRepository.findByEmail(email).orElseThrow(() ->
                new RestErrorResponseException(forStatusAndDetail(BAD_REQUEST, "Invalid email or token")
